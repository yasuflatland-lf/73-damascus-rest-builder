...
public class SampleSBAdminCrudMVCRenderCommand implements MVCRenderCommand {

	/**
	 * Edit Page JSP file
	 */
	public String getEditPageJSP() {
		return SampleSBWebKeys.ADMIN_EDIT_JSP;
	}
	...
	public String getViewRecordPageJSP() {
		return SampleSBWebKeys.ADMIN_VIEW_RECORD_JSP;
	}
