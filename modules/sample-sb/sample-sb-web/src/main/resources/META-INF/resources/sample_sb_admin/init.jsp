...
page import="com.liferay.sb.test.model.SampleSB" %><%@
page import="com.liferay.sb.test.web.constants.*" %><%@
page import="com.liferay.sb.test.web.constants.SampleSBWebKeys" %><%@
...
page import="com.liferay.sb.test.web.portlet.action.SampleSBConfiguration" %><%@
page import="com.liferay.sb.test.web.upload.SampleSBItemSelectorHelper" %><%@
...
prefsViewType = HtmlUtil.escape(portletPreferences.getValue("prefsViewType", String.valueOf(sampleSBConfiguration.prefsViewType())));

dateFormatVal = HtmlUtil.escape(portletPreferences.getValue("dateFormat", sampleSBConfiguration.dateFormat()));

datetimeFormatVal = HtmlUtil.escape(portletPreferences.getValue("datetimeFormat", sampleSBConfiguration.datetimeFormat()));

datePickerFormatVal = HtmlUtil.escape(portletPreferences.getValue("datePickerFormat", sampleSBConfiguration.datePickerFormat()));
}
%>
